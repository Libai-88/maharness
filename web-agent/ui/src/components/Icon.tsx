...
/** 换相机（贴纸重拍）：旋转 + 相机 */
export const IconSwapPhoto = (p: IconProps) => (
  <Svg {...p}><path d="M20 12 a8 8 0 1 1 -2.5 -5.8" /><path d="M20 3 v4 h-4" /><rect x="6.5" y="12" width="11" height="9" rx="2" /><circle cx="12" cy="16.5" r="2.1" /></Svg>
);
